...
export const seeToTry: Pathway = {
	...
	tags: ['perception', 'modality', 'colexification', 'multiverb-construction', 'auxiliary-verb', 'metaphor', 'metonymy', 'semantic-bleaching', 'grammaticalization', 'several-macroareas'],
	evidenceNote:
