...
export const existence: Pattern = {
	...
	attestations: [
		...
		{ language: 'eu', strategy: 'general-locational', expression: 'egon (dago / daude)', confidence: 'medium', note: 'egon is the stage-level locative copula, against izan for identity, and its lexical domain is “stay, remain” rather than a body posture. Western and central varieties select egon in existentials; eastern varieties use izan, and the ba- prefixed forms are a further pattern. Confidence is medium because a single row hides that variation.', origin: { value: 'stay', evidence: 'established' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'] },
		{ language: 'sw', strategy: 'general-locational', expression: '-ko / -po / -mo', confidence: 'high', note: 'an agreeing locative copula built on the locative noun classes (16 pa-, 17 ku-, 18 mu-) and related to the locative referential concords. It states location — mbwa yuko nyumbani “the dog is at the house” — and existence alike: watu wapo “there are people”.', origin: { value: 'deictic', evidence: 'established' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], sources: [{ source: 'marten-2013' }] },
