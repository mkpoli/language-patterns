...
export const existence: Pattern = {
	...
	attestations: [
		...
		{ language: 'et', strategy: 'general-locational', expression: 'on', confidence: 'high', note: 'the copula olema, with the ground in the inessive and the pivot nominative — toas on kass. Possession takes an adessive possessor on the same predicate, as in Finnish: mul on raamat.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence', 'possession'], citationNeeded: true },
		{ language: 'lv', strategy: 'general-locational', expression: 'ir', confidence: 'high', note: 'the copula būt, with a locative ground — istabā ir kaķis. Possession puts the possessor in the dative on the same predicate: man ir grāmata.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence', 'possession'], citationNeeded: true },
		{ language: 'lt', strategy: 'general-locational', expression: 'yra', confidence: 'medium', note: 'the copula būti — kambaryje yra katė. Recorded without possession: Lithuanian differs from Latvian in using the transitive turėti for ordinary possession rather than a dative frame on this predicate.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'mn', strategy: 'general-locational', expression: 'байна', transliteration: 'baina', confidence: 'medium', note: 'the copula байх “be”, with the ground in the dative-locative — өрөөнд муур байна. Recorded without possession: Mongolian ordinary possession uses the comitative -тай rather than this predicate alone.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		...
		{ language: 'pl', strategy: 'general-locational', expression: 'jest', confidence: 'high', note: 'the copula być, with ground-first order carrying the existential reading — w pokoju jest kot. Negation switches the pivot to the genitive under nie ma rather than negating jest.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'cs', strategy: 'general-locational', expression: 'je', confidence: 'high', note: 'the copula být, unchanged between v místnosti je kočka and the definite locational clause.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'sk', strategy: 'general-locational', expression: 'je', confidence: 'high', note: 'the copula byť, patterning with Czech.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'sl', strategy: 'general-locational', expression: 'je', confidence: 'high', note: 'the copula biti; v sobi je mačka differs from the locational clause by definiteness and order alone.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'sr', strategy: 'general-locational', expression: 'је', transliteration: 'je', confidence: 'medium', note: 'the copula бити. има “has” also heads existentials, so this row covers only the copular pattern.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'hr', strategy: 'general-locational', expression: 'je', confidence: 'medium', note: 'the copula biti, beside an ima existential of the Bulgarian type.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'bs', strategy: 'general-locational', expression: 'je', confidence: 'medium', note: 'the copula biti, as in the neighbouring standards, beside an ima existential.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'grc', strategy: 'general-locational', expression: 'ἔστιν', transliteration: 'éstin', confidence: 'medium', note: 'the copula εἰμί, accented on the first syllable in its existential use. The dative of possession runs on the same copula — ἔστι μοι “to me is”, as in Latin est mihi.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence', 'possession'], citationNeeded: true },
		{ language: 'eo', strategy: 'general-locational', expression: 'estas', confidence: 'high', note: 'the copula esti, unchanged between estas kato en la ĉambro and the definite locational clause. Possession is the transitive havi, so the copula does not carry it.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		...
		{ language: 'ur', strategy: 'general-locational', expression: 'ہے', transliteration: 'hai', confidence: 'high', note: 'the copula honā, the same predicate as Hindi है, carrying possession with a postpositional possessor — mere pās kitāb hai.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence', 'possession'], citationNeeded: true },
		{ language: 'ne', strategy: 'general-locational', expression: 'छ', transliteration: 'cha', confidence: 'medium', note: 'the copula हुनु, unchanged between the existential and the definite locational clause. Possession takes a comitative possessor — मसँग किताब छ.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence', 'possession'], citationNeeded: true },
		{ language: 'bn', strategy: 'general-locational', expression: 'আছে', transliteration: 'ache', confidence: 'high', note: 'the third-person form of the root আছ- “be, exist”, which also carries possession — আমার একটা ভাই আছে “I have a brother”.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence', 'possession'], citationNeeded: true },
		{ language: 'fa', strategy: 'general-locational', expression: 'است', transliteration: 'ast', confidence: 'high', note: 'the copula budan. The emphatic existential هست hast stands beside it and is the form Tajik generalized. Possession is the transitive داشتن dāštan, so the copula does not carry it.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		{ language: 'ps', strategy: 'general-locational', expression: 'ده / دی', transliteration: 'da / di', confidence: 'medium', note: 'the copula, agreeing with the pivot in gender and number; the existential differs from the locational clause by definiteness and order rather than by predicate.', origin: { value: 'be', evidence: 'transparent' }, proform: 'none', headAlsoLocates: true, syncretism: ['location', 'existence'], citationNeeded: true },
		...
		{ language: 'nb', strategy: 'copular-proform', expression: 'det er', confidence: 'high', note: 'expletive det “it”, not a locative. Nynorsk has the same frame — det er ein katt.', origin: { value: 'be', evidence: 'transparent' }, proform: 'expletive', headAlsoLocates: true, syncretism: ['location', 'existence'], sources: [{ source: 'faarlund-lie-vannebo-1997' }] },
		{ language: 'is', strategy: 'copular-proform', expression: 'það er', confidence: 'high', note: 'expletive það “it”; the pivot stays indefinite while the plain copula locates definite subjects.', origin: { value: 'be', evidence: 'transparent' }, proform: 'expletive', headAlsoLocates: true, syncretism: ['location', 'existence'], sources: [{ source: 'thrainsson-2007' }] },
		...
		{ language: 'bg', strategy: 'possessive', expression: 'има', transliteration: 'ima', confidence: 'high', note: 'the ordinary possessive verb имам used impersonally — има котка в стаята. The pivot is an object and controls no agreement, and plain location takes the copula instead.', origin: { value: 'have', evidence: 'transparent' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'mk', strategy: 'possessive', expression: 'има', transliteration: 'ima', confidence: 'high', note: 'the same impersonal има as Bulgarian, the Balkan areal pattern against the copular existentials further north.', origin: { value: 'have', evidence: 'transparent' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'sq', strategy: 'possessive', expression: 'ka', confidence: 'medium', note: 'the possessive verb kam “have” used impersonally — në dhomë ka një mace. The Balkan areal pattern shared with Bulgarian and Macedonian има, across unrelated branches.', origin: { value: 'have', evidence: 'transparent' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'th', strategy: 'possessive', expression: 'มี', transliteration: 'mii', confidence: 'high', note: 'the ordinary possessive verb “have” heads the existential — มีแมวอยู่ในห้อง. Plain location of a known entity takes อยู่ yùu instead.', origin: { value: 'have', evidence: 'transparent' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'lo', strategy: 'possessive', expression: 'ມີ', transliteration: 'mī', confidence: 'medium', note: 'the Thai มี pattern in the neighbouring Kra-Dai language: the possessive verb serving as the existential predicate.', origin: { value: 'have', evidence: 'transparent' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'km', strategy: 'possessive', expression: 'មាន', transliteration: 'miən', confidence: 'medium', note: 'the possessive verb “have” as existential predicate — មានឆ្មានៅក្នុងបន្ទប់. The areal pattern of mainland Southeast Asia, shared with Thai, Lao, Vietnamese and Chinese across three unrelated families.', origin: { value: 'have', evidence: 'transparent' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		...
		{ language: 'az', strategy: 'specialized-existential', expression: 'var', confidence: 'high', note: 'the Turkic existential predicate, taking copular rather than verbal morphology and absent from plain locational clauses. It carries possession on the same frame, with the possessed noun marked, and is negated by the suppletive yoxdur.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'tk', strategy: 'specialized-existential', expression: 'bar', confidence: 'medium', note: 'the Turkic existential predicate, taking copular rather than verbal morphology and absent from plain locational clauses. It carries possession on the same frame, with the possessed noun marked, and is negated by the suppletive ýok.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'uz', strategy: 'specialized-existential', expression: 'bor', confidence: 'high', note: 'the Turkic existential predicate, taking copular rather than verbal morphology and absent from plain locational clauses. It carries possession on the same frame, with the possessed noun marked, and is negated by the suppletive yoʻq.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'kk', strategy: 'specialized-existential', expression: 'бар', transliteration: 'bar', confidence: 'high', note: 'the Turkic existential predicate, taking copular rather than verbal morphology and absent from plain locational clauses. It carries possession on the same frame, with the possessed noun marked, and is negated by the suppletive жоқ.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'ky', strategy: 'specialized-existential', expression: 'бар', transliteration: 'bar', confidence: 'medium', note: 'the Turkic existential predicate, taking copular rather than verbal morphology and absent from plain locational clauses. It carries possession on the same frame, with the possessed noun marked, and is negated by the suppletive жок.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'tt', strategy: 'specialized-existential', expression: 'бар', transliteration: 'bar', confidence: 'medium', note: 'the Turkic existential predicate, taking copular rather than verbal morphology and absent from plain locational clauses. It carries possession on the same frame, with the possessed noun marked, and is negated by the suppletive юк.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'ba', strategy: 'specialized-existential', expression: 'бар', transliteration: 'bar', confidence: 'medium', note: 'the Turkic existential predicate, taking copular rather than verbal morphology and absent from plain locational clauses. It carries possession on the same frame, with the possessed noun marked, and is negated by the suppletive юҡ.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'ug', strategy: 'specialized-existential', expression: 'بار', transliteration: 'bar', confidence: 'medium', note: 'the Turkic existential predicate, taking copular rather than verbal morphology and absent from plain locational clauses. It carries possession on the same frame, with the possessed noun marked, and is negated by the suppletive yoq.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'el', strategy: 'specialized-existential', expression: 'υπάρχει', transliteration: 'ypárchei', confidence: 'high', note: 'υπάρχω “exist” as a dedicated existential predicate, which plain location does not use — there the copula είναι serves. Impersonal έχει “has” is a further colloquial existential.', origin: { value: 'exist', evidence: 'transparent' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence'], citationNeeded: true },
		{ language: 'hy', strategy: 'specialized-existential', expression: 'կա', transliteration: 'ka', confidence: 'medium', note: 'a dedicated existential predicate distinct from the copula է, carrying possession on a locative frame — ինձ մոտ կա. Suppletive negative չկա.', origin: { value: 'exist', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		...
		{ language: 'uk', strategy: 'specialized-existential', expression: 'є', transliteration: 'je', confidence: 'medium', note: 'є continues the 3SG present of бути, which the ordinary present locational clause otherwise leaves out. It carries possession on the same locative frame — у мене є книга.', origin: { value: 'be', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'be', strategy: 'specialized-existential', expression: 'ёсць', transliteration: 'josć', confidence: 'medium', note: 'the Russian есть pattern: a present-tense form kept for existential and possessive assertion — у мяне ёсць кніга.', origin: { value: 'be', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence', 'possession'], citationNeeded: true },
		{ language: 'tg', strategy: 'specialized-existential', expression: 'ҳаст', transliteration: 'hast', confidence: 'medium', note: 'Tajik uses the hast form of the Persian pair, not the plain copula аст: дар ҳуҷра як гурба ҳаст. Recorded as specialized on that contrast, against the Persian row where аст heads both clause types.', origin: { value: 'be', evidence: 'established' }, proform: 'none', headAlsoLocates: false, syncretism: ['existence'], citationNeeded: true },
	...
	examples: [
		...
		{ language: 'af', original: 'Daar is \'n kat in die kamer.', gloss: 'EXPL COP INDF cat INE DEF room', literal: 'There is a cat in the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'sq', original: 'Në dhomë ka një mace.', gloss: 'INE room EXIST INDF cat', literal: 'In room has a cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'grc', original: 'ἔστιν αἴλουρος ἐν τῷ δωματίῳ.', transliteration: 'éstin aílouros en tōi dōmatíōi.', gloss: 'EXIST.3SG cat-NOM INE DEF.DAT.N.SG room-DAT.SG', literal: 'Is cat in the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'hy', original: 'Սենյակում կա կատու:', transliteration: 'Senyakum ka katu', gloss: 'room-INE EXIST.3SG cat', literal: 'In-room exists cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ast', original: 'Hai un gatu na habitación.', gloss: 'EXIST INDF.M.SG cat in=DEF.F.SG room', literal: 'Has a cat in-the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'az', original: 'Otaqda bir pişik var.', gloss: 'room-LOC INDF cat EXIST', literal: 'In-room a cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ba', original: 'Бүлмәдә бер бесәй бар.', transliteration: 'Bülmädä ber besäy bar.', gloss: 'room-LOC INDF cat EXIST', literal: 'In-room a cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'be', original: 'У пакоі ёсць кот.', transliteration: 'U pakoï josć kot.', gloss: 'INE room-LOC.SG EXIST cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'bn', original: 'ঘরে একটি বিড়াল আছে।', transliteration: 'Ghore ekti biral achhe.', gloss: 'room-LOC INDF-CLF cat EXIST.3SG', literal: 'In-room one-CLF cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'bs', original: 'U sobi je mačka.', gloss: 'INE room-LOC COP.3SG cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'br', original: 'Ur c\'hazh a zo en sal.', gloss: 'INDF cat PTCL EXIST INE room', literal: 'A cat PTCL is in room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'bg', original: 'Има котка в стаята.', transliteration: 'Ima kotka v stayata.', gloss: 'EXIST cat INE room-DEF', literal: 'Has cat in room-the.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ca', original: 'Hi ha un gat a l\'habitació.', gloss: 'EXPL EXIST INDF cat LOC DEF=room', literal: 'There has a cat at the-room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'kw', original: 'Yma kath y\'n stevel.', gloss: 'EXIST cat INE=DEF room', literal: 'Is cat in-the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'co', original: 'Ci hè un gattu in a stanza.', gloss: 'EXPL COP INDF cat INE DEF room', literal: 'There is a cat in the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'hr', original: 'U sobi je mačka.', gloss: 'INE room-LOC COP.3SG cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'cs', original: 'V místnosti je kočka.', gloss: 'INE room-LOC COP.3SG cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'da', original: 'Der er en kat i værelset.', gloss: 'EXPL COP INDF cat INE room-DEF', literal: 'There is a cat in room-the.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'nl', original: 'Er is een kat in de kamer.', gloss: 'EXPL COP INDF cat INE DEF room', literal: 'There is a cat in the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'eo', original: 'Estas kato en la ĉambro.', gloss: 'COP.PRES cat INE DEF room', literal: 'Is cat in the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'et', original: 'Toas on kass.', gloss: 'room-INE COP.3SG cat-NOM', literal: 'In-room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'fo', original: 'Tað er ein køttur í stovuni.', gloss: 'EXPL COP INDF cat-NOM INE room-DEF', literal: 'It is a cat in room-the.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'fy', original: 'Der is in kat yn \'e keamer.', gloss: 'EXPL COP INDF cat INE DEF room', literal: 'There is a cat in the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'gl', original: 'Hai un gato na habitación.', gloss: 'EXIST INDF.M.SG cat in=DEF.F.SG room', literal: 'Has a cat in-the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'el', original: 'Υπάρχει μια γάτα στο δωμάτιο.', transliteration: 'Ypárchei mia gáta sto domátio.', gloss: 'EXIST.3SG INDF.F.SG cat in=DEF.N.SG room', literal: 'Exists a cat in-the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'is', original: 'Það er köttur í herberginu.', gloss: 'EXPL COP cat-NOM INE room-DEF', literal: 'It is cat in room-the.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ga', original: 'Tá cat sa seomra.', gloss: 'EXIST cat in=DEF room', literal: 'Is cat in-the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'kk', original: 'Бөлмеде бір мысық бар.', transliteration: 'Bölmede bir mysyq bar.', gloss: 'room-LOC INDF cat EXIST', literal: 'In-room a cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'km', original: 'មានឆ្មានៅក្នុងបន្ទប់', transliteration: 'miən chmaa nɨw knong bantup.', gloss: 'EXIST cat LOC in room', literal: 'Have cat at in room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ky', original: 'Бөлмөдө бир мышык бар.', transliteration: 'bölmödö bir mışık bar.', gloss: 'room-LOC INDF cat EXIST', literal: 'In-room a cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'lo', original: 'ມີແມວໃນຫ້ອງ', transliteration: 'mī mǣu nai hǭng', gloss: 'EXIST cat INE room', literal: 'Have cat in room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'lv', original: 'Istabā ir kaķis.', gloss: 'room-LOC COP.3SG cat-NOM', literal: 'In-room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'lt', original: 'Kambaryje yra katė.', gloss: 'room-LOC COP.3SG cat-NOM', literal: 'In-room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'lb', original: 'Et ass eng Kaz an der Chambre.', gloss: 'EXPL COP INDF cat INE DEF room', literal: 'It is a cat in the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'mk', original: 'Има мачка во собата.', transliteration: 'Ima mačka vo sobata.', gloss: 'EXIST cat INE room-DEF', literal: 'Has cat in room-the.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'gv', original: 'Ta kayt ayns y shamyr.', gloss: 'EXIST cat INE DEF room', literal: 'Is cat in the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'mn', original: 'Өрөөнд муур байна.', transliteration: 'Öröönd muur bajna.', gloss: 'room-LOC cat EXIST', literal: 'In-room cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ne', original: 'कोठामा एउटा बिरालो छ।', transliteration: 'Kothāmā eutā birālo cha.', gloss: 'room-LOC INDF-CLF cat EXIST.3SG', literal: 'In-room one-CLF cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'nb', original: 'Det er en katt i rommet.', gloss: 'EXPL COP INDF cat INE room-DEF', literal: 'It is a cat in room-the.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'oc', original: 'I a un cat dins la cambra.', gloss: 'EXPL EXIST INDF cat INE DEF room', literal: 'There has a cat inside the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ps', original: 'په کوټه کې یوه پیشو ده.', transliteration: 'pə koṭa ke yawə pisho da.', gloss: 'in room POSTP INDF.F cat.F COP.3SG.F', literal: 'In room in a cat is.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'fa', original: 'یک گربه در اتاق است.', transliteration: 'yek gorbe dar otāgh ast.', gloss: 'INDF cat INE room COP.3SG', literal: 'A cat in room is.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'pl', original: 'W pokoju jest kot.', gloss: 'INE room-LOC COP.3SG cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'pt', original: 'Há um gato no quarto.', gloss: 'EXIST INDF.M.SG cat in=DEF.M.SG room', literal: 'Has a cat in-the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ro', original: 'Este o pisică în cameră.', gloss: 'COP.3SG INDF.F.SG cat INE room', literal: 'Is a cat in room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'gd', original: 'Tha cat sa t-seòmar.', gloss: 'EXIST cat in=DEF room', literal: 'Is cat in-the room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'sr', original: 'У соби је мачка.', transliteration: 'U sobi je mačka.', gloss: 'INE room-LOC COP.3SG cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'sk', original: 'V miestnosti je mačka.', gloss: 'INE room-LOC COP.3SG cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'sl', original: 'V sobi je mačka.', gloss: 'INE room-LOC COP.3SG cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'tg', original: 'Дар ҳуҷра як гурба ҳаст.', transliteration: 'Dar hujra yak gurba hast.', gloss: 'INE room INDF cat EXIST.3SG', literal: 'In room a cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'tt', original: 'Бүлмәдә бер мәче бар.', transliteration: 'Bülmädä ber mäçe bar.', gloss: 'room-LOC INDF cat EXIST', literal: 'In-room a cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'th', original: 'มีแมวอยู่ในห้อง', transliteration: 'mii mɛɛo yùu nai hɔ̂ng', gloss: 'EXIST cat LOC INE room', literal: 'Have cat located in room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'tk', original: 'Otagda bir pişik bar.', gloss: 'room-LOC INDF cat EXIST', literal: 'In-room a cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'uk', original: 'У кімнаті є кіт.', transliteration: 'U kimnati ye kit.', gloss: 'INE room-LOC EXIST cat-NOM', literal: 'In room is cat.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'ur', original: 'کمرے میں ایک بلی ہے', transliteration: 'Kamre mein ek billi hai.', gloss: 'room.OBL INE INDF cat COP.PRES.3SG', literal: 'In room a cat is.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'uz', original: 'Xonada bir mushuk bor.', gloss: 'room-LOC INDF cat EXIST', literal: 'In-room a cat exists.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'wa', original: 'I gn a on tchèt dins l\'pîce.', gloss: 'EXPL LOC EXIST INDF cat INE DEF=room', literal: 'It there has a cat in the-room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
		{ language: 'yi', original: 'עס איז אַ קאַץ אין צימער.', transliteration: 'Es iz a kats in tsimer.', gloss: 'EXPL COP INDF cat INE room', literal: 'There is a cat in room.', natural: 'There is a cat in the room.', set: 'cat-in-room', citationNeeded: true },
	],
	exampleSets: [
		{
			id: 'inanimate',
